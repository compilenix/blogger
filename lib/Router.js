...
class Router {
   ...
   * @returns {any} response object from RequestHandler
   * @memberOf Router
   */
   ...
   * @public
   * @param {string} pathname
   * @returns {any|boolean} the requested route object or false
   * @memberOf Router
   */
  getRoute (pathname) {
    if (this.requestHandlersMappings === null) return false
