...
tests.push({
	test: () => {
		...
		cache.clear();
		pass &= test_false(cache.has(dummy_request), "cache file not present after cache clear");
		cache.add(dummy_request, dummy_content, dummy_mimetype, dummy_mimetype);
...
tests.push({
	test: () => {
		...
		cache.clear();
		pass &= test_false(cache.has(dummy_request), "mem cache entry not present after cache clear");
		cache.add(dummy_request, dummy_content, dummy_mimetype, dummy_mimetype);
