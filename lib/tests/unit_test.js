...
function log (msg, log_level) {
  switch (log_level) {
    case WARNING:
      process.stdout.write('\x1b[33mWarning\x1b[0m: ' + msg + '\n')
      break
    case NOTICE:
      process.stdout.write('\x1b[36mNotice\x1b[0m: ' + msg + '\x1b[0m\n')
      break
    case DEBUG:
      process.stdout.write('\x1b[33mDebug\x1b[0m: ' + msg + '\x1b[0m\n')
      break
    case GOOD:
      process.stdout.write('\x1b[32mPASSED\x1b[0m: ' + msg + '\x1b[0m\n')
      break
  }
}
