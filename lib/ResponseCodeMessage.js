...
class ResponseCodeMessage {
	...
	prepareAndGetResponse(overwriteContent) {
		if (this.message == null || this.message == "") {
			this.message = this.getMessageFromCode(this.response.getResponseCode());
	...
	generateContent() {
		return "<html><head><title>" +
			...
			"</title><meta charset=\"UTF-8\"></head><body bgcolor=\"white\"><center><h1>" +
			this.code + " " + this.message +
			"</h1></center><hr><center>" +
			config.ServerVersion + "</center></body></html>\n";
	}
