...
function generateContent(code, message) {
    return "<html><head><title>" + code + " " + message + "</title><meta charset=\"UTF-8\"></head><body bgcolor=\"white\"><center><h1>" + code + " " + message + "</h1></center><hr><center>" + (global.Config.ServerVersion || "node.js/" + process.version) + "</center></body></html>\n";
}
...
function getDefaultMessage(code) {
    ...
    switch (code) {
        ...
        case 789: m = "Not my department"; break;
        ...
        default: m = "Internal Server Error";
    }
    return m;
}
